...
#         ):
#             transformed = data_preprocessing.transform_text("Hello this is running 123!")
...
#     with patch.object(data_preprocessing, "transform_text", new=lambda text: text.lower()):
...
#     with patch.object(
#         data_preprocessing.pd, "read_csv", side_effect=FileNotFoundError("missing")
#     ):
#         data_preprocessing.main()
...
#     with patch.object(data_preprocessing.pd, "read_csv", side_effect=Exception("boom")):
